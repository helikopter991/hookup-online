  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/40 backdrop-blur-xl border-b border-white/5 py-5 px-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between relative">
        <a href="/" className="flex items-center gap-2 group font-black tracking-tighter text-2xl uppercase">
          <img 
            src="https://bit.ly/3P22Eb9" 
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-orange-500/10 blur-[150px] rounded-full animate-pulse"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-500 text-[10px] font-black uppercase tracking-[0.2em] mb-10">
             <Star size={12} fill="currentColor" />
             {t.Hero.badge}
          </div>
          
          <h1 className="text-6xl md:text-[140px] font-black text-white mb-6 tracking-tighter leading-[0.8] uppercase italic">
            {t.Hero.title1} <span className="text-orange-500 not-italic">{t.Hero.title2}</span>
          </h1>
          
          <p className="text-white/30 text-lg md:text-2xl font-medium mb-12 max-w-3xl mx-auto lowercase tracking-tighter leading-tight">
            {t.Hero.subtitle}
          </p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between border-b border-white/10 pb-10 mb-10 gap-8">
           <div className="flex items-center gap-4">
              ...
              <div className="space-y-1">
                <h2 className="text-2xl font-black text-white tracking-[0.2em] uppercase leading-none">
                  HOOK UP DIGITAL MARKET
                </h2>
                <div className="w-full h-0.5 bg-orange-500/20"></div>
              </div>
           </div>
